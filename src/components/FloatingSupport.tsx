  ...
  return (
    <div className="fixed items-center box-border caret-transparent gap-x-2 flex outline-[3px] gap-y-2 z-50 left-5 bottom-5">
      <button
        ...
        className="text-gray-600 items-center bg-white shadow-[rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0.1)_0px_4px_6px_-1px,rgba(0,0,0,0.1)_0px_2px_4px_-2px] caret-transparent flex h-8 justify-center min-h-[auto] min-w-[auto] outline-[3px] text-center w-8 p-0 rounded-full"
      >
