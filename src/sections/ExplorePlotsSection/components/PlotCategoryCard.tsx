...
export const PlotCategoryCard = (props: PlotCategoryCardProps) => {
  return (
    <div className="relative bg-white shadow-[rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0.05)_0px_1px_2px_0px] box-border caret-transparent min-h-[auto] min-w-[auto] outline-[3px] border border-gray-200 overflow-hidden rounded-2xl border-solid">
      <div className="relative box-border caret-transparent h-56 outline-[3px] overflow-hidden">
        <img
          src={props.imageUrl}
          alt={props.imageAlt}
          className="aspect-[auto_640_/_480] box-border caret-transparent h-full max-w-full object-cover outline-[3px] w-full"
        />
